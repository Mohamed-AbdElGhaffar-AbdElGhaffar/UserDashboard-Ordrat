...
import { ProductDetailsInput, buildProductDetailsSchema } from '@/validators/product-details.schema';
...
export default function ProductDetailsSummery({
  ...
  const productDetailsSchema = buildProductDetailsSchema(productVariations);
