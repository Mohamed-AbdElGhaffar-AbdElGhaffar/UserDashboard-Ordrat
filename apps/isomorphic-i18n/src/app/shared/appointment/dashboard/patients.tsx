...
export default function Patients({ className,lang }: { className?: string;lang?: string  }) {
      ...
      <div className="h-full items-center gap-4 @sm:flex">
        ...
        <div className="@sm:w-2/5 @sm:ps-2">
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <Detail color={COLORS[0]} value={45} text="Dental" />
            <Detail color={COLORS[2]} value={32} text="Gyneco" />
            <Detail color={COLORS[3]} value={16} text="Orthop" />
          </div>
        </div>
      </div>
    </WidgetCard>
