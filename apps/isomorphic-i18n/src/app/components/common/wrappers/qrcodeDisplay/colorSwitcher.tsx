...
import { IAction, QrStyleContext } from '@/app/components/contsxt1';
...
const ColorSwitcher = ({ change }: BackgroundColorsProps) => {
  ...
  return (
    <>
      <div className="flex flex-wrap rounded-full justify-center gap-x-0 gap-y-3">{colorButtonsJSX}</div>
    </>
  );
};
