...
export default function AddDriver({
  ...
  const mainFormSchema = Yup.object().shape({
    ...
    .min(8, lang === 'ar' ? 'كلمة المرور يجب ألا تقل عن 8 أحرف' : 'Password must be at least 8 characters long'),
  ...
  return (
    <div className="py-1">
      <WidgetCard title='' className="flex flex-col gap-4">
        <form
          className="relative"
          onSubmit={(e) => {
            e.preventDefault();
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
              ...
              <div>
                <UploadZone
                  ...
                  recommendedDimensionsTitle={lang=='ar'?'خلفية بيضاء':'White Background'}
                />
              </div>
              <div>
                <UploadZone
