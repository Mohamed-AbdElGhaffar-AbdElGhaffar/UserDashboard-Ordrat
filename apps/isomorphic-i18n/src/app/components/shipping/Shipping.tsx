                ...
                {({
                    ...
                    return (
                        <>
                            ...
                            <div className="mx-auto  grid w-full max-w-screen-2xl gap-7 @2xl:gap-9 @3xl:gap-11">
                                <div title={t('addsetting')} className='space-y-4 border border-muted bg-gray-0 p-5 dark:bg-gray-50 lg:p-7 rounded-lg'>
                                    <div className="flex justify-between ">
                                        <h3 className="text-base font-semibold sm:text-lg">{t('addsetting')}</h3>
                                        {/* <button>{lang == "en" ? "Update Store" : 'تعديل متجر'}</button> */}
                                        <UpdateAddStoreButton lang={lang} title={lang == "en" ? "Update Store" : 'تعديل متجر'} buttonLabel={lang == "en" ? "Update Store" : 'تعديل متجر'} modalBtnLabel={lang == "en" ? "Update Store" : 'تعديل متجر'} onSuccess={() => {
                                            console.log('true');
                                        }} />            </div>
