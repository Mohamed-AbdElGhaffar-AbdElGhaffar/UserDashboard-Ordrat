...
export default function UpdateCategoryForm({
  ...
  const text = {
    ...
    TitleEn: lang === 'ar' ? 'أسم الموقع (انجليزي)' : 'Page Title (English)',
    TitleAr: lang === 'ar' ? 'أسم الموقع (عربي)' : 'Page Title (Arabic)',
    MetaDescriptionEn: lang === 'ar' ? 'وصف الموقع (انجليزي)' : 'Meta Description (English)',
    MetaDescriptionAr: lang === 'ar' ? 'وصف الموقع (عربي)' : 'Meta Description (Arabic)',
