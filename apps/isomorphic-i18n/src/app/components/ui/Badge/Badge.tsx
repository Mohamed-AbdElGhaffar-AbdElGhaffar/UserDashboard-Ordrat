...
import { useLayout } from '../../../../../../isomorphic/src/layouts/use-layout';
...
export default function DivBadge({ title, status }: { title: string; status:string; }) {
  const { layout } = useLayout();
  const colorStatus = status?.toLowerCase() === 'danger' ? 'danger' : 'success';
